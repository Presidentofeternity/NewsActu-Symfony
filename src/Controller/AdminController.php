...
class AdminController extends AbstractController
{
        ...
        if($form->isSubmitted() && $form->isValid()) {
            ...
            if($file) {
               ...
               // $safeFilename = $slugger->slug($originalFilename);
                ...
                try {
                    //on a configurer un parametre 'upload_dir' dans le fichier service.yaml
    ...
    public function updateArticle(Article $article, Request $request, EntityManagerInterface $entityManager, SluggerInterface $slugger): Response
    {
       # Condition ternaire : $article->getPhoto() ?? '' ;
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            if($file) {
               ...
               // $safeFilename = $slugger->slug($originalFilename);
                ...
                try {
                    ...
                    # code à exécuteer si une erreur est attrapé
            ...
            $this->addFlash('success', "L'article" . $article->getTitle() . "à bien été modifier ! ");
    ...
    public function hardDeleteArticle(Article $article, EntityManagerInterface $entityManager): Response
    {
        ...
        $this->addFlash('success', "l'article" . $article->getTitle() . " a bien supprimimé de la base de données");
